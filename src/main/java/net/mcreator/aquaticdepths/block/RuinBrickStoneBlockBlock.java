...
public class RuinBrickStoneBlockBlock extends AquaticDepthsModElements.ModElement {
	@ObjectHolder("aquatic_depths:ruin_brick_stone_block")
	public static final Block block = null;

	public RuinBrickStoneBlockBlock(AquaticDepthsModElements instance) {
		super(instance, 11);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("ruin_brick_stone_block");
		}
