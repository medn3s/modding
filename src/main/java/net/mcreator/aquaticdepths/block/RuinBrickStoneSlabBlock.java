...
public class RuinBrickStoneSlabBlock extends AquaticDepthsModElements.ModElement {
	@ObjectHolder("aquatic_depths:ruin_brick_stone_slab")
	public static final Block block = null;

	public RuinBrickStoneSlabBlock(AquaticDepthsModElements instance) {
		super(instance, 12);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("ruin_brick_stone_slab");
		}
