...
public class StoneBlockBlock extends AquaticDepthsModElements.ModElement {
	@ObjectHolder("aquatic_depths:stone_block")
	public static final Block block = null;

	public StoneBlockBlock(AquaticDepthsModElements instance) {
		super(instance, 8);
	}
