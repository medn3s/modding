...
import net.mcreator.aquaticdepths.procedures.WitherblockEntityWalksOnTheBlockProcedure;
...
public class WitherblockBlock extends AquaticDepthsModElements.ModElement {
	@ObjectHolder("aquatic_depths:witherblock")
	public static final Block block = null;

	public WitherblockBlock(AquaticDepthsModElements instance) {
		super(instance, 15);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void animateTick(BlockState blockstate, World world, BlockPos pos, Random random) {
			...
			if (true)
				for (int l = 0; l < 1; ++l) {
					...
					world.addParticle(ParticleTypes.SQUID_INK, d0, d1, d2, 0, 0, 0);
				}
		}
		...
		public void onEntityWalk(World world, BlockPos pos, Entity entity) {
			...
			WitherblockEntityWalksOnTheBlockProcedure
